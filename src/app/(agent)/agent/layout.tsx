    ...
    <div className="min-h-screen flex bg-[#FAF7F2] text-[#1C1C1A] font-sans selection:bg-[#E8622C]/20">
      ...
      <aside className="w-64 bg-[#F4EFE6] border-r border-[#1C1C1A]/10 flex flex-col justify-between">
        <div className="p-6">
          ...
          <div className="bg-white/60 border border-[#1C1C1A]/10 rounded-xl p-4 mb-6 text-center space-y-2">
            <span className="text-[10px] text-[#1C1C1A]/40 font-bold uppercase tracking-wider">Duty Status</span>
            <div className="flex justify-between items-center bg-[#FAF7F2] border border-[#1C1C1A]/10 rounded-lg p-2">
              ...
              <motion.button
                ...
                className={`py-1 px-3 rounded text-[10px] font-bold transition-all border ${
                  available
                    ...
                    : 'bg-emerald-550/10 hover:bg-emerald-600 border-emerald-200 text-emerald-600 hover:text-white'
                }`}
              >
        ...
        <div className="p-4 border-t border-[#1C1C1A]/10 flex flex-col gap-2">
          <div className="px-3 py-2">
            <p className="text-[10px] text-[#1C1C1A]/40 font-bold uppercase tracking-wider">Agent Panel</p>
